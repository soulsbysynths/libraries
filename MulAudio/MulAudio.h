//MulAudio.h  Atmegatron Audio output (328P PWM pin)
...
#ifndef __MULAUDIO_H__
#define __MULAUDIO_H__
...
//functions
public:
	MulAudio(unsigned char waveLen);
	~MulAudio();
...
private:
	MulAudio() {}
	MulAudio( const MulAudio &c );
	MulAudio& operator=( const MulAudio &c );

}; //MulAudio

#endif //__MULAUDIO_H__
