//AteOscHardwareBase.h  Atmegatron Eurorack Oscitron Hardware control base class.
...
#ifndef ATEOSCHARDWAREBASEH_
#define ATEOSCHARDWAREBASEH_

class AteOscHardwareBase
{
	public:
