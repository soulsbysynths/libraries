...
protected:
private:
	//unsigned char funcValue_c_[10] = {0x00,0x00,0x0F,0x6A,0xFF,0xF0,0x27,0x07,0x06,0x01};
	//unsigned char optionValue_c_[2] = {0xB0,0x06};
	//unsigned char ctrlValue_[6] = {0xFF,0x00,0x40,0xB4,0x00,0x00};
	unsigned char funcValue_c_[10] = {0x00,0x00,0x00,0x00,0xF0,0x00,0xF0,0x00,0x00,0x00};
	unsigned char optionValue_c_[2] = {0x00,0x00};
	unsigned char ctrlValue_[6] = {0x00,0x00,0x00,0xFF,0x00,0x00};
